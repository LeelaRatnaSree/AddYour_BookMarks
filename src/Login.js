...
export default function Login() {
  return (
    <div style={{zoom:'110%'}}>
      <div style={{color:'white',backgroundColor:'#42618f',border:'2px solid black',fontSize:25,paddingBottom:'10px'}}> <strong style={{paddingRight:'400px'}}> Book Mark Manager</strong> Login</div>
      <div className="my-0" style={{paddingLeft:'280px',border:'2px solid black',backgroundColor:'#c6c1cf',paddingBottom:'380px'}}>
            ...
            <div style={{paddingLeft:'270px',fontSize:25,paddingBottom:'50px'}}>
                <button type="button" className="btn btn-outline-dark btn-lg" style={{backgroundColor:'#42618f',textDecoration:'none'}} id="loginButton" ><Link to="/Navbar" style={{textDecoration:'none',color:'white'}}>Login</Link></button>
